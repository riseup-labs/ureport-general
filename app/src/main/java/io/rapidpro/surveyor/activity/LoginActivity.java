...
import io.rapidpro.surveyor.extend.fragment.OfflineUreportListFragment;
...
public class LoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_passwordView.setOnEditorActionListener((textView, id, keyEvent) -> {
        ...
        ConstraintLayout emailSignInButton = findViewById(R.id.email_sign_in_button);
        ...
        findViewById(R.id.btnSkipLogin).setOnClickListener(view -> {
            ...
            intent.putExtra(SurveyorIntent.EXTRA_ORG_UUID, "invalid");
