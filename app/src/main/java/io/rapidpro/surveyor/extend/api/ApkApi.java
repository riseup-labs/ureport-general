...
public interface ApkApi {
    ...
    String BASE_URL_GV = "https://ureport-offline-global.unicefbangladesh.org/api/";//"https://ureport-offline-global.unicefbangladesh.org/api/";

    // Base URL for Non-General Version
    String BASE_URL_RV = "https://ureport-offline-global.unicefbangladesh.org/api/";
