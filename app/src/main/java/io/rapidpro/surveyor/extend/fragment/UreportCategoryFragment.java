...
import io.rapidpro.surveyor.extend.UreportListActivity;
...
public class UreportCategoryFragment extends BaseFragment implements CustomAdapterPollList.ItemClickListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        List<String> uReportLocalList = uReportDao.getUreportCategories();
        ...
        adapter = new CustomAdapterPollList(getSurveyor(), context, pollNameList, pollIDList, pollDateList, true, -1);
    ...
    public void onItemClick(View view, int position) {
        ...
        Intent intent = new Intent(context, UreportListActivity.class);
        ...
        intent.putExtra("ColorPosition",  (position % 7));
