...
public class OrgFragment extends BaseFragment implements FlowListFragment.Container {
    ...
    protected void promptToUpgrade() {
        ...
        ((TextView) dialog4.findViewById(R.id.button_yes_text)).setText(getString(R.string.yes));
        ((TextView) dialog4.findViewById(R.id.button_no_text)).setText(getString(R.string.no));
