...
public class DashboardActivity extends BaseActivity implements CustomScrollAdapter.ClickListener {
    ...
    void initDashboard() {
        ...
        dashboardLists.add(new DashboardList_RV(getString(R.string.v1_stories), R.drawable.v1_card_bg_stories, R.drawable.v1_header_image_stories, R.drawable.v1_bg_shade_stories));
        dashboardLists.add(new DashboardList_RV(getString(R.string.v1_ureport), R.drawable.v1_card_bg_opinions,  R.drawable.v1_header_image_results, R.drawable.v1_bg_shade_results));
        dashboardLists.add(new DashboardList_RV(getString(R.string.v1_survey), R.drawable.v1_card_bg_reports,  R.drawable.v1_header_image_opinion, R.drawable.v1_bg_shades_opinions));
        dashboardLists.add(new DashboardList_RV(getString(R.string.v1_settings), R.drawable.v1_card_bg_settings,  R.drawable.v1_header_image_settings, R.drawable.v1_bg_shade_settings));
...
//                }
    ...
    public void onItemClick(int position, View v) {
        ...
        if(position == 1) {intent = new Intent(DashboardActivity.this, ResultSelectionActivity.class);}
...
//        }
        ...
        if(position == 2 && !isLoggedIn()){
            ...
            ix.putExtra("fromDashboard", true);
            //ix.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        ...
        //Pair<View, String> p5 = Pair.create((View)bgColor, bgColor.getTransitionName());
        ...
        //fade.excludeChildren(bgColor, true);
